...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class FunctionsSyncServiceTests
    {
        ...
        [Theory]
        [InlineData(true, true, false, true, true, true, false, false, false)] // in standby
        [InlineData(true, true, false, false, true, true, false, false, false)] // in standby
        [InlineData(true, true, false, true, true, false, false, false, false)] // in standby
        [InlineData(true, true, false, false, true, false, true, false, false)] // in standby
        [InlineData(true, true, false, false, true, false, false, true, false)] // in standby
        [InlineData(true, true, false, true, false, true, false, false, true)]
        [InlineData(true, true, false, false, false, true, false, false, true)]
        [InlineData(false, true, true, true, false, false, false, false, false)] // container not ready
        [InlineData(false, true, true, false, false, false, false, false, false)] // container not ready
        [InlineData(false, true, true, true, false, true, false, false, true)]
        [InlineData(false, true, true, false, false, true, false, false, true)]
        [InlineData(false, false, true, true, false, true, false, false, false)] // no encryption key
